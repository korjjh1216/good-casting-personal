...
import { messageSelector, getMessageList } from '../../state/reducer/message.reducer';
...
const MessageDropdown = () => {
    ...
    return (
        <>
            ...
            {msgList.map((msg) => {
                return (
                    <p className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase">{msg.actionType}</p>
                );
            })}
        </>
    );
