...
import { FormLabel, FormControl, FormControlLabel, Radio, RadioGroup, styled } from '@material-ui/core';
...
const BpIcon = styled('span')(({ theme }) => ({
    ...
    backgroundColor: theme.palette.mode === 'dark' ? '#755dd9' : '##755dd9',
    ...
    'input:hover ~ &': {
        backgroundColor: theme.palette.mode === 'dark' ? '#30404d' : '##755dd9',
    },
    'input:disabled ~ &': {
        boxShadow: 'none',
...
export default function CustomizedRadios() {
    ...
    return (
        <FormControl component="fieldset">
            ...
            <RadioGroup defaultValue="female" aria-label="gender" name="customized-radios" onChange={onChange}>
