...
import { hireSelector, hireDelete, hireList, resetStatus } from '../../state/reducer/hire.reducer';
...
const DashboardHireList = () => {
    ...
    console.info(pageResult.dtoList);
    return (
        <>
                                ...
                                <tbody>
                                    {pageResult.dtoList.length ? (
                                        pageResult.dtoList.map((hire) => {
                                            return (
                                                <>
                                                    <tr className="border border-color-2" key={hire.hireId}>
                                                        ...
                                                        <td className="table-y-middle py-7 min-width-px-135">
                                                            <h3 className="font-size-4 font-weight-normal text-black-2 mb-0">{hire.cast}</h3>
                                                        </td>
                                                        <td className="table-y-middle py-7 min-width-px-125">
                                                            <h3 className="font-size-4 font-weight-normal text-black-2 mb-0">{hire.regDate.slice(0, 10)}</h3>
                                                        </td>
                                                        <td className="table-y-middle py-7 min-width-px-155">
                                                            <h3 className="font-size-4 font-weight-normal text-black-2 mb-0">{hire.deadline.slice(0, 10)}</h3>
                                                        </td>
                                                        <td className="table-y-middle py-7 min-width-px-125">
                                                            <h3 className="font-size-4 font-weight-normal text-black-2 mb-0">{hire.personnel}</h3>
                                                        </td>
                                                        ...
                                                        <td className="table-y-middle py-7 min-width-px-100">
                                                            <a
                                                                ...
                                                                onClick={(e) => {
                                                                    e.preventDefault();
                                                                    dispatch(hireDelete(hire.hireId));
                                                                }}
                                                            >
                                                                삭제하기
                                                            </a>
