                            ...
                            <div className="header-btn-devider ml-auto ml-lg-5 pl-2 d-none d-xs-flex align-items-center">
                                <div>
                                    <Dropdown className="show-gr-dropdown py-5">
                                        ...
                                        {size.width <= 991 ? <Dropdown.Menu className="gr-menu-dropdown border-0 border-width-2 py-2 w-auto bg-default" key="1"></Dropdown.Menu> : <div className="dropdown-menu gr-menu-dropdown dropdown-right border-0 border-width-2 py-2 w-auto bg-default" key="2"></div>}
                                    </Dropdown>
                                </div>
                                <div>
                                    <Dropdown className="show-gr-dropdown py-5">
                                        ...
                                        {size.width <= 991 ? (
                                            <Dropdown.Menu className="gr-menu-dropdown border-0 border-width-2 py-2 w-auto bg-default" key="1">
                                                <Link to="/actor-register" className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase">
                                                    프로필 등록
                                                </Link>
                                                <Link to="/actor-applylist" className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase">
                                                    지원리스트
                                                </Link>
                                            ...
                                            <div className="dropdown-menu gr-menu-dropdown dropdown-right border-0 border-width-2 py-2 w-auto bg-default" key="2">
                                                <Link to="/dashboard-hires" className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase">
                                                    공고문 리스트
                                                </Link>
                                                <Link to="/dashboard-applicants" className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase">
                                                    지원자 리스트
                                                </Link>
                                                <Link to="/dashboard-settings" className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase">
                                                    정보수정
                                                </Link>
                                            </div>
                                        )}
